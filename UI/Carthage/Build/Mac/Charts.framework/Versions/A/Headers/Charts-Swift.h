...
SWIFT_MODULE_NAMESPACE_PUSH("Charts")
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, strong) NSFont * _Nonnull labelFont;
@property (nonatomic, strong) NSColor * _Nonnull labelTextColor;
@property (nonatomic, strong) NSColor * _Nonnull axisLineColor;
...
/// This property is deprecated - Use <code>axisMinimum</code> instead.
@property (nonatomic) double axisMinValue;
/// This property is deprecated - Use <code>axisMaximum</code> instead.
...
- (nonnull instancetype)initWithViewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler SWIFT_UNAVAILABLE;
@end
...
- (void)initializeWithDataSets:(NSArray<id <IChartDataSet>> * _Nonnull)dataSets;
...
- (NSInteger)getDataSetIndexByLabel:(NSString * _Nonnull)label ignorecase:(BOOL)ignorecase SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// The labels of all DataSets as a string array.
- (NSArray<NSString *> * _Nonnull)dataSetLabels SWIFT_WARN_UNUSED_RESULT;
...
- (NSArray<NSColor *> * _Nullable)getColors SWIFT_WARN_UNUSED_RESULT;
/// Sets a custom IValueFormatter for all DataSets this data object contains.
- (void)setValueFormatter:(id <IChartValueFormatter> _Nullable)formatter;
/// Sets the color of the value-text (color in which the value-labels are drawn) for all DataSets this data object contains.
- (void)setValueTextColor:(NSColor * _Null_unspecified)color;
/// Sets the font for all value-labels for all DataSets this data object contains.
- (void)setValueFont:(NSFont * _Null_unspecified)font;
...
/// \param the starting point on the x -axis where the grouping should begin
///
...
///
- (nonnull instancetype)initWithY:(double)y icon:(NSImage * _Nullable)icon OBJC_DESIGNATED_INITIALIZER;
/// \param y the y value (the actual value of the entry)
///
/// \param icon icon image
///
/// \param data Space for additional data this Entry represents.
///
- (nonnull instancetype)initWithY:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data OBJC_DESIGNATED_INITIALIZER;
...
/// \param icon icon image
///
- (nonnull instancetype)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon OBJC_DESIGNATED_INITIALIZER;
/// An Entry represents one single entry in the chart.
/// \param x the x value
///
/// \param y the y value (the actual value of the entry)
...
/// \param data Space for additional data this Entry represents.
///
- (nonnull instancetype)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data OBJC_DESIGNATED_INITIALIZER;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
...
- (nonnull instancetype)initWithY:(double)y icon:(NSImage * _Nullable)icon SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithY:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data SWIFT_UNAVAILABLE;
@end
...
/// This constructor is misleading, please use the <code>data</code> argument instead of <code>label</code>.
...
/// Constructor for stacked bar entries. One data object for whole stack
- (nonnull instancetype)initWithX:(double)x yValues:(NSArray<NSNumber *> * _Nonnull)yValues icon:(NSImage * _Nullable)icon data:(id _Nullable)data OBJC_DESIGNATED_INITIALIZER;
/// Constructor for stacked bar entries. One data object for whole stack
- (nonnull instancetype)initWithX:(double)x yValues:(NSArray<NSNumber *> * _Nonnull)yValues icon:(NSImage * _Nullable)icon OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, readonly, copy) NSArray<NSColor *> * _Nonnull valueColors;
/// All the colors that are used for this DataSet.
/// Colors are reused as soon as the number of Entries the DataSet represents is higher than the size of the colors array.
@property (nonatomic, readonly, copy) NSArray<NSColor *> * _Nonnull colors;
///
/// returns:
/// The color at the given index of the DataSet’s color array.
/// This prevents out-of-bounds by performing a modulus on the color index, so colours will repeat themselves.
- (NSColor * _Nonnull)colorAtIndex:(NSInteger)atIndex SWIFT_WARN_UNUSED_RESULT;
- (void)resetColors;
- (void)addColor:(NSColor * _Nonnull)color;
- (void)setColor:(NSColor * _Nonnull)color;
...
@property (nonatomic, strong) NSColor * _Nonnull valueTextColor;
///
/// returns:
/// The color at the specified index that is used for drawing the values inside the chart. Uses modulus internally.
- (NSColor * _Nonnull)valueTextColorAt:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
/// the font for the value-text labels
@property (nonatomic, strong) NSFont * _Nonnull valueFont;
...
/// All the colors that are used for this DataSet.
/// Colors are reused as soon as the number of Entries the DataSet represents is higher than the size of the colors array.
@property (nonatomic, copy) NSArray<NSColor *> * _Nonnull colors;
/// List representing all colors that are used for drawing the actual values for this DataSet
@property (nonatomic, copy) NSArray<NSColor *> * _Nonnull valueColors;
/// The label string that describes the DataSet.
...
/// The color at the given index of the DataSet’s color array.
/// This prevents out-of-bounds by performing a modulus on the color index, so colours will repeat themselves.
- (NSColor * _Nonnull)colorAtIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
...
///
- (void)setColor:(NSColor * _Nonnull)color alpha:(CGFloat)alpha;
/// Sets colors with a specific alpha value.
/// \param colors the colors to set
///
/// \param alpha alpha to apply to the set <code>colors</code>
///
- (void)setColors:(NSArray<NSColor *> * _Nonnull)colors alpha:(CGFloat)alpha;
/// if true, value highlighting is enabled
@property (nonatomic) BOOL highlightEnabled;
///
/// returns:
...
///
/// returns:
/// <code>true</code> if the entry was removed successfully, else if the entry does not exist
- (BOOL)removeEntry:(ChartDataEntry * _Nonnull)entry SWIFT_WARN_UNUSED_RESULT;
/// Removes the first Entry (at index 0) of this DataSet from the entries array.
///
/// returns:
/// <code>true</code> if successful, <code>false</code> ifnot.
- (BOOL)removeFirst SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)isInBoundsXWithEntry:(ChartDataEntry * _Nonnull)e dataSet:(id <IBarLineScatterCandleBubbleChartDataSet> _Nonnull)dataSet SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// <code>true</code> if the DataSet values should be drawn, <code>false</code> if not.
- (BOOL)shouldDrawValuesForDataSet:(id <IChartDataSet> _Nonnull)set SWIFT_WARN_UNUSED_RESULT;
@end
...
- (nonnull instancetype)initWithDataProvider:(id <BarChartDataProvider> _Nullable)dataProvider animator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)initBuffers SWIFT_METHOD_FAMILY(none);
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
...
- (void)drawValueWithContext:(CGContextRef _Nonnull)context value:(NSString * _Nonnull)value xPos:(CGFloat)xPos yPos:(CGFloat)yPos font:(NSFont * _Nonnull)font align:(NSTextAlignment)align color:(NSColor * _Nonnull)color;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<ChartHighlight *> * _Nonnull)indices;
...
/// This property is deprecated - Use <code>chartDescription.text</code> instead.
@property (nonatomic, copy) NSString * _Nonnull descriptionText;
/// This property is deprecated - Use <code>chartDescription.font</code> instead.
@property (nonatomic, strong) NSFont * _Nullable descriptionFont;
/// This property is deprecated - Use <code>chartDescription.textColor</code> instead.
@property (nonatomic, strong) NSColor * _Nullable descriptionTextColor;
/// This property is deprecated - Use <code>chartDescription.textAlign</code> instead.
...
@property (nonatomic, strong) NSFont * _Null_unspecified noDataFont;
/// color of the no data text
@property (nonatomic, strong) NSColor * _Nonnull noDataTextColor;
...
- (NSImage * _Nullable)getChartImageWithTransparent:(BOOL)transparent SWIFT_WARN_UNUSED_RESULT;
...
@interface BarLineChartViewBase : ChartViewBase <NSGestureRecognizerDelegate, BarLineScatterCandleBubbleChartDataProvider>
/// the maximum number of entries to which values will be drawn
/// (entry numbers greater than this value will cause value-labels to disappear)
@property (nonatomic) NSInteger _maxVisibleCount;
/// the color for the background of the chart-drawing area (everything behind the grid lines).
@property (nonatomic, strong) NSColor * _Nonnull gridBackgroundColor;
...
@property (nonatomic, strong) NSClickGestureRecognizer * _Null_unspecified _tapGestureRecognizer;
@property (nonatomic, strong) NSClickGestureRecognizer * _Null_unspecified _doubleTapGestureRecognizer;
@property (nonatomic, strong) NSMagnificationGestureRecognizer * _Null_unspecified _pinchGestureRecognizer;
@property (nonatomic, strong) NSPanGestureRecognizer * _Null_unspecified _panGestureRecognizer;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)initialize;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
...
- (BOOL)gestureRecognizer:(NSGestureRecognizer * _Nonnull)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(NSGestureRecognizer * _Nonnull)otherGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
...
- (id <IBarLineScatterCandleBubbleChartDataSet> _Null_unspecified)getDataSetByTouchPointWithPoint:(CGPoint)pt SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
...
///
/// returns:
/// The current set X axis renderer
...
///
/// returns:
/// An array of <code>Highlight</code> objects corresponding to the selected xValue and dataSetIndex.
- (NSArray<ChartHighlight *> * _Nonnull)buildHighlightsWithDataSet:(id <IChartDataSet> _Nonnull)set dataSetIndex:(NSInteger)dataSetIndex xValue:(double)xValue rounding:(enum ChartDataSetRounding)rounding SWIFT_WARN_UNUSED_RESULT;
///
/// returns:
/// The minimum distance from a touch-y-value (in pixels) to the closest y-value (in pixels) that is displayed in the chart.
- (CGFloat)getMinimumDistanceWithClosestValues:(NSArray<ChartHighlight *> * _Nonnull)closestValues y:(CGFloat)y axis:(enum AxisDependency)axis SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)getHighlightPosWithHigh:(ChartHighlight * _Nonnull)high SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)getDistanceWithX1:(CGFloat)x1 y1:(CGFloat)y1 x2:(CGFloat)x2 y2:(CGFloat)y2 SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, strong) ChartData * _Nullable data;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
/// \param icon icon image
///
- (nonnull instancetype)initWithX:(double)x y:(double)y size:(CGFloat)size icon:(NSImage * _Nullable)icon OBJC_DESIGNATED_INITIALIZER;
/// \param x The index on the x-axis.
///
/// \param y The value on the y-axis.
///
...
/// \param data Spot for additional data this Entry represents.
///
- (nonnull instancetype)initWithX:(double)x y:(double)y size:(CGFloat)size icon:(NSImage * _Nullable)icon data:(id _Nullable)data OBJC_DESIGNATED_INITIALIZER;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithX:(double)x y:(double)y icon:(NSImage * _Nullable)icon data:(id _Nullable)data SWIFT_UNAVAILABLE;
@end
...
- (nonnull instancetype)initWithDataProvider:(id <BubbleChartDataProvider> _Nullable)dataProvider animator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
...
- (nonnull instancetype)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(NSImage * _Nullable)icon OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithX:(double)x shadowH:(double)shadowH shadowL:(double)shadowL open:(double)open close:(double)close icon:(NSImage * _Nullable)icon data:(id _Nullable)data OBJC_DESIGNATED_INITIALIZER;
///
/// returns:
...
- (nonnull instancetype)initWithDataProvider:(id <CandleChartDataProvider> _Nullable)dataProvider animator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
...
+ (NSArray<NSColor *> * _Nonnull)liberty SWIFT_WARN_UNUSED_RESULT;
+ (NSArray<NSColor *> * _Nonnull)joyful SWIFT_WARN_UNUSED_RESULT;
+ (NSArray<NSColor *> * _Nonnull)pastel SWIFT_WARN_UNUSED_RESULT;
+ (NSArray<NSColor *> * _Nonnull)colorful SWIFT_WARN_UNUSED_RESULT;
+ (NSArray<NSColor *> * _Nonnull)vordiplom SWIFT_WARN_UNUSED_RESULT;
+ (NSArray<NSColor *> * _Nonnull)material SWIFT_WARN_UNUSED_RESULT;
+ (NSColor * _Nonnull)colorFromString:(NSString * _Nonnull)colorString SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@protocol IShapeRenderer <NSObject>
...
///
- (void)renderShapeWithContext:(CGContextRef _Nonnull)context dataSet:(id <IScatterChartDataSet> _Nonnull)dataSet viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler point:(CGPoint)point color:(NSColor * _Nonnull)color;
@end
...
- (nonnull instancetype)initWithColor:(NSColor * _Nonnull)color;
...
- (nonnull instancetype)initWithImage:(NSImage * _Nonnull)image tiled:(BOOL)tiled;
- (nonnull instancetype)initWithCGImage:(CGImageRef _Nonnull)CGImage;
- (nonnull instancetype)initWithImage:(NSImage * _Nonnull)image;
...
+ (ChartFill * _Nonnull)fillWithColor:(NSColor * _Nonnull)color SWIFT_WARN_UNUSED_RESULT;
...
+ (ChartFill * _Nonnull)fillWithImage:(NSImage * _Nonnull)image tiled:(BOOL)tiled SWIFT_WARN_UNUSED_RESULT;
+ (ChartFill * _Nonnull)fillWithCGImage:(CGImageRef _Nonnull)CGImage SWIFT_WARN_UNUSED_RESULT;
+ (ChartFill * _Nonnull)fillWithImage:(NSImage * _Nonnull)image SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM_NAMED(NSInteger, ChartFillType, "FillType") {
...
- (NSColor * _Nullable)getCircleColorAtIndex:(NSInteger)atIndex SWIFT_WARN_UNUSED_RESULT;
...
/// <em>default</em>: nil
@property (nonatomic, readonly, strong) NSColor * _Nullable scatterShapeHoleColor;
///
/// returns:
...
/// This property is deprecated - Use <code>horizontalAlignment</code>, <code>verticalAlignment</code>, <code>orientation</code>, <code>drawInside</code>, <code>direction</code>.
...
- (CGSize)getMaximumEntrySizeWithFont:(NSFont * _Nonnull)font SWIFT_WARN_UNUSED_RESULT;
...
- (void)calculateDimensionsWithLabelFont:(NSFont * _Nonnull)labelFont viewPortHandler:(ChartViewPortHandler * _Nonnull)viewPortHandler;
/// MARK: - Custom legend
...
/// This constructor is deprecated - Use <code>init(entries:)</code>
...
/// This property is deprecated - Use <code>extraEntries</code>
@property (nonatomic, readonly, copy) NSArray<NSObject *> * _Nonnull extraColorsObjc;
/// This property is deprecated - Use <code>extraLabels</code>
@property (nonatomic, readonly, copy) NSArray<NSObject *> * _Nonnull extraLabelsObjc;
/// This property is deprecated - Use <code>colors</code>
@property (nonatomic, copy) NSArray<NSObject *> * _Nonnull colorsObjc;
/// This property is deprecated - Use <code>labels</code>
@property (nonatomic, copy) NSArray<NSObject *> * _Nonnull labelsObjc;
/// This function is deprecated - Use <code>entries</code>
- (NSString * _Nullable)getLabel:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
/// This function is deprecated - Use <code>Use</code>extra(entries:)`
- (void)setExtraWithColors:(NSArray<NSObject *> * _Nonnull)colors labels:(NSArray<NSObject *> * _Nonnull)labels;
/// This function is deprecated - Use <code>Use</code>setCustom(entries:)`
...
///
- (nonnull instancetype)initWithLabel:(NSString * _Nullable)label form:(enum ChartLegendForm)form formSize:(CGFloat)formSize formLineWidth:(CGFloat)formLineWidth formLineDashPhase:(CGFloat)formLineDashPhase formLineDashLengths:(NSArray<NSNumber *> * _Nullable)formLineDashLengths formColor:(NSColor * _Nullable)formColor OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic, strong) NSColor * _Nullable formColor;
@end
...
- (void)drawLabelWithContext:(CGContextRef _Nonnull)context x:(CGFloat)x y:(CGFloat)y label:(NSString * _Nonnull)label font:(NSFont * _Nonnull)font textColor:(NSColor * _Nonnull)textColor;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithViewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler SWIFT_UNAVAILABLE;
@end
...
/// The color at the given index of the DataSet’s circle-color array.
/// Performs a IndexOutOfBounds check by modulus.
- (NSColor * _Nullable)getCircleColorAtIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
/// Sets the one and ONLY color that should be used for this DataSet.
/// Internally, this recreates the colors array and adds the specified color.
- (void)setCircleColor:(NSColor * _Nonnull)color;
/// Resets the circle-colors array and creates a new one
...
- (void)drawFilledPathWithContext:(CGContextRef _Nonnull)context path:(CGPathRef _Nonnull)path fillColor:(NSColor * _Nonnull)fillColor fillAlpha:(CGFloat)fillAlpha;
@end
...
- (nonnull instancetype)initWithDataProvider:(id <LineChartDataProvider> _Nullable)dataProvider animator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
...
- (void)refreshContentWithEntry:(ChartDataEntry * _Nonnull)entry highlight:(ChartHighlight * _Nonnull)highlight;
- (void)drawWithContext:(CGContextRef _Nonnull)context point:(CGPoint)point;
+ (ChartMarkerView * _Nullable)viewFromXib SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// \param icon icon image
///
- (nonnull instancetype)initWithValue:(double)value label:(NSString * _Nullable)label icon:(NSImage * _Nullable)icon;
/// \param value The value on the y-axis
///
/// \param label The label for the x-axis
///
...
/// \param data Spot for additional data this Entry represents
///
- (nonnull instancetype)initWithValue:(double)value label:(NSString * _Nullable)label icon:(NSImage * _Nullable)icon data:(id _Nullable)data OBJC_DESIGNATED_INITIALIZER;
/// \param value The value on the y-axis
///
...
/// \param icon icon image
///
- (nonnull instancetype)initWithValue:(double)value icon:(NSImage * _Nullable)icon;
/// \param value The value on the y-axis
///
/// \param icon icon image
///
/// \param data Spot for additional data this Entry represents
///
- (nonnull instancetype)initWithValue:(double)value icon:(NSImage * _Nullable)icon data:(id _Nullable)data;
@property (nonatomic, copy) NSString * _Nullable label;
...
@property (nonatomic, strong) NSColor * _Nullable holeColor;
...
@property (nonatomic, strong) NSColor * _Nullable transparentCircleColor;
...
- (void)drawHighlightedWithContext:(CGContextRef _Nonnull)context indices:(NSArray<ChartHighlight *> * _Nonnull)indices;
- (void)drawHighlightCircleWithContext:(CGContextRef _Nonnull)context atPoint:(CGPoint)point innerRadius:(CGFloat)innerRadius outerRadius:(CGFloat)outerRadius fillColor:(NSColor * _Nullable)fillColor strokeColor:(NSColor * _Nullable)strokeColor strokeWidth:(CGFloat)strokeWidth;
- (nonnull instancetype)initWithAnimator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler SWIFT_UNAVAILABLE;
@end
...
@property (nonatomic, strong) NSColor * _Nonnull webColor;
/// color for the web lines in between the lines that come from the center.
@property (nonatomic, strong) NSColor * _Nonnull innerWebColor;
...
- (NSArray<ChartHighlight *> * _Nonnull)getHighlightsForIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithChart:(id <ChartDataProvider> _Nonnull)chart OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)initWithDataProvider:(id <ScatterChartDataProvider> _Nullable)dataProvider animator:(ChartAnimator * _Nullable)animator viewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler OBJC_DESIGNATED_INITIALIZER;
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
...
- (CGAffineTransform)refreshWithNewMatrix:(CGAffineTransform)newMatrix chart:(ChartViewBase * _Nonnull)chart invalidate:(BOOL)invalidate SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithViewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler transformer:(ChartTransformer * _Nullable)transformer axis:(ChartAxisBase * _Nullable)axis SWIFT_UNAVAILABLE;
@end
...
- (void)renderAxisLineWithContext:(CGContextRef _Nonnull)context;
- (void)renderLimitLinesWithContext:(CGContextRef _Nonnull)context;
- (nonnull instancetype)initWithViewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler xAxis:(ChartXAxis * _Nullable)xAxis transformer:(ChartTransformer * _Nullable)transformer SWIFT_UNAVAILABLE;
@end
...
@property (nonatomic, strong) NSColor * _Nullable zeroLineColor;
...
- (void)renderAxisLabelsWithContext:(CGContextRef _Nonnull)context;
- (void)renderLimitLinesWithContext:(CGContextRef _Nonnull)context;
- (nonnull instancetype)initWithViewPortHandler:(ChartViewPortHandler * _Nullable)viewPortHandler yAxis:(ChartYAxis * _Nullable)yAxis transformer:(ChartTransformer * _Nullable)transformer SWIFT_UNAVAILABLE;
@end
